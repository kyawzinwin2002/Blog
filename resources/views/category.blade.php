        ...
        <div class="">
            ...
            @if (request()->has("keyword") && $category->title)
                <div class=" d-flex justify-content-between">
                    <p>Showing result by : {{request()->keyword}} and categorized by {{$category->title}}</p>
                    <a href="{{route("page.index")}}" class=" text-dark">Show All</a>
                </div>

                @elseif ($category->title)

                <div class=" d-flex justify-content-between">
                    <p >Article categorize by : {{$category->title}}</p>
                    <a href="{{route("page.index")}}" class=" text-dark">Show All</a>
                </div>
            @endif
